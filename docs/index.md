...
piskie is a small, hook-driven engine. A YAML config declares:
...
For a given target piskie builds a render **context** and produces netboot files
...
| `piskie[docs]`   | Build this documentation site (`mkdocs`) |
...
- [API Reference](api.md) — the `Piskie` engine and context objects.
